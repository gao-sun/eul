//
//  PreferenceStatusBarView.swift
//  eul
//
//  Created by Haohan Yang on 2020/10/27.
//  Copyright © 2020 Haohan Yang. All rights reserved.
//

import SwiftUI

extension Preference {
    struct PreferenceStatusBarView: View {
            ...
            VStack(alignment: .leading, spacing: 12) {
                HStack(alignment: .top, spacing: 20) {
                    VStack(alignment: .leading, spacing: 8) {
                        HStack {
                            Text("ui.status_bar_view".localized())
                                .subsection()
